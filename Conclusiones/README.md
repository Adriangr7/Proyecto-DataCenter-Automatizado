...
En este proyecto se ha diseñado e implementado con éxito un tejido de red de centro de datos moderno basado en una arquitectura Spine–Leaf, utilizando BGP como protocolo de enrutamiento en el plano underlay y VXLAN EVPN como tecnología de overlay para proporcionar conectividad de capa 2 sobre una infraestructura de capa 3.
...
Como líneas de trabajo futuras, este proyecto podría ampliarse mediante la incorporación de mecanismos avanzados de alta disponibilidad, políticas de seguridad basadas en microsegmentación, integración con sistemas de orquestación más avanzados o el uso de herramientas de CI/CD para la validación continua de configuraciones de red.
